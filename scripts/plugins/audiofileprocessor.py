    ...
    try:
        ...
        for track in tracks:
            ...
            for instrumenttrack in track.findall('./instrumenttrack'):
                ...
                # Adicionando suporte para o plugin "audiofileprocessor"
                ...
                if instrument is not None:
                    ...
                    # Verificar se é o "audiofileprocessor" e extrair os atributos
                    if instrument_name.lower() == "audiofileprocessor":
                        audiofileprocessor = instrument.find('.//audiofileprocessor')  # Buscando pelo plugin "audiofileprocessor"
