    ...
    try:
        ...
        for track in tracks:
            ...
            for instrumenttrack in track.findall('./instrumenttrack'):
                ...
                # Adicionando suporte para o plugin "gigplayer"
                ...
                if instrument is not None:
                    ...
                    # Verificar se é o "gigplayer" e extrair os atributos
                    if instrument_name.lower() == "gigplayer":
                        gigplayer = instrument.find('.//gigplayer')  # Buscando pelo plugin "gigplayer"
                        if gigplayer is not None:
                            instrument_info['gigplayer'] = {}
                            for key, value in gigplayer.attrib.items():
                                instrument_info['gigplayer'][key] = value
