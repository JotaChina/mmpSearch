    ...
    try:
        ...
        for track in tracks:
            ...
            for instrumenttrack in track.findall('./instrumenttrack'):
                ...
                # Adicionando suporte para o plugin "kicker"
                ...
                if instrument is not None:
                    ...
                    # Verificar se é o "kicker" e extrair os atributos
                    if instrument_name.lower() == "kicker":
                        kicker = instrument.find('.//kicker')  # Buscando pelo plugin "kicker"
                        if kicker is not None:
                            instrument_info['kicker'] = {}
                            for key, value in kicker.attrib.items():
                                instrument_info['kicker'][key] = value
