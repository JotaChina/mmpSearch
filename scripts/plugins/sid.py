    ...
    try:
        ...
        for track in tracks:
            ...
            for instrumenttrack in track.findall('./instrumenttrack'):
                ...
                # Adicionando suporte para o plugin "sid"
                ...
                if instrument is not None:
                    ...
                    # Verificar se é o "sid" e extrair os atributos
                    if instrument_name.lower() == "sid":
                        sid = instrument.find('.//sid')  # Buscando pelo plugin "sid"
                        if sid is not None:
                            instrument_info['sid'] = {}
                            for key, value in sid.attrib.items():
                                instrument_info['sid'][key] = value
